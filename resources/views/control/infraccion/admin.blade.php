...
<div class="container" id="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Infraccion</div>
						  ...
						  <div class="card">
							<div class="card-header">
							  <div class="card-tools">
								...
								{!! Form::button(' <i class="fas fa-upload"></i> Actualizar UIT', array('class' => 'btn  btn-outline-secondary', 'id' => 'btnNuevo', 'onclick' => 'modal (\''.URL::route($ruta["create"], array('listar'=>'SI', 'tipo'=>'uit')).'\', \''.'Actualizar Valor de UIT'.'\', this);')) !!}
							</div>
							</div>
							<!-- /.card-header -->

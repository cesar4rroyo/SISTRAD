...
<div class="container" id="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Subtipos de trámite</div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4  form-group">
                            {!! Form::label('tipotramite', 'Tipo de trámite') !!}
                            {!! Form::select('tipotramite', $tipostramite , '', array('class' => 'form-control ', 'id' => 'tipotramite' ,'onchange' => 'buscar(\''.$entidad.'\')')) !!}
                        </div>

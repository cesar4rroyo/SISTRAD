...
<div class="container">
    <div class="row">
        @include ('admin.cargo.modalAgregar')
        @include ('admin.cargo.modalEditar')
        <div class="col-md-12">
            <div class="card">
            ...
            .then((data)=>{                
                ...
                var table= $('#nacionalidad').DataTable( {
                    ...
                    $('#nacionalidad tbody').on( 'click', 'button', function () { 
                        ...
                        var urlLocal = "http://localhost/tramite/public/admin/cargo/show" + '/' + id;
